-- Run in Supabase SQL Editor if db push is blocked by older pending migrations.
-- CJ: https://cjdropshipping.com/product/korean-style-loose-fitting-sports-top-for-students-p-2603030850021614800.html
