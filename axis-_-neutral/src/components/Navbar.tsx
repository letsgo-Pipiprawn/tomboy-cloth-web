      ...
      >
        ...
        <div className="flex items-center gap-3 sm:gap-5 justify-end">
          ...
          <button
            ...
            className="text-brand-white hover:text-brand-slate transition-colors"
          ...
          <Link
            ...
            className="hidden sm:block text-brand-white hover:text-brand-slate transition-colors"
          ...
          <Link
            ...
            className="relative hidden sm:block text-brand-white hover:text-brand-slate transition-colors"
